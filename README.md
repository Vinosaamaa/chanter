...
**Active phase: Product Readiness and Public Production Launch** — epic [#107](https://github.com/Vinosaamaa/chanter/issues/107). Issues [#238](https://github.com/Vinosaamaa/chanter/issues/238) and [#239](https://github.com/Vinosaamaa/chanter/issues/239) are complete; start [#240](https://github.com/Vinosaamaa/chanter/issues/240), then follow [`docs/issues/product-readiness-issue-breakdown.md`](docs/issues/product-readiness-issue-breakdown.md) in dependency order.
...
**Active:** [Product Readiness and Public Production Launch #107](https://github.com/Vinosaamaa/chanter/issues/107). Issues [#238](https://github.com/Vinosaamaa/chanter/issues/238) and [#239](https://github.com/Vinosaamaa/chanter/issues/239) are complete; implement [#240](https://github.com/Vinosaamaa/chanter/issues/240) next and continue in [`docs/issues/product-readiness-issue-breakdown.md`](docs/issues/product-readiness-issue-breakdown.md) order.

...
export default defineConfig({
  ...
  projects: [
    ...
    ...(['firefox', 'webkit'] as const).map(browserName => ({ name: browserName, use: { browserName }, grep: /course-chat at 390|course-overview at 1280|phone Questions|phone Inbox|phone Friends|phone landscape|sign-in at 390|clipped course tabs|mobile marketing menu/ })),
  ],

...
import { createStudyServerCta, MARKETING_DEMO_PATH, MARKETING_SIGN_IN_PATH } from '../marketing-routes'
    ...
    <header className="sticky top-0 z-20 border-b border-app-border/80 bg-app-bg/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-4">
        ...
        <nav aria-label="Marketing" className="hidden items-center gap-6 md:flex">
          ...
          <a
            href="https://github.com/Vinosaamaa/chanter"
            className="text-sm text-app-muted transition-colors hover:text-app-text"
            rel="noreferrer"
            target="_blank"
          >
  ...
  return (
    <div>
        ...
        <p className="mt-4 max-w-xl text-lg text-app-muted">
          Chanter brings your course to life with organized channels, AI study support, TA queues,
          and powerful instructor tools — all in one collaborative space.
        </p>

...
**Current owner direction and execution:** [`launch-execution-status.md`](docs/operations/launch-execution-status.md) tracks the free-resource constraint, configurable AI providers and modern responsive UI. Account security, deployment packaging, private resources, durable events, ingestion, retrieval, moderation, native companion, edge controls and the initial UI reconstruction are merged. Lifecycle #251, integrated product interaction #339 and complete source/object recovery #342 remain active. Monitoring #331 and recovery #332 retain their provider and release gates. All workers use Astra High at normal speed. No public deployment is claimed.

**Active phase:** [#107 Product Readiness and Public Production Launch](https://github.com/Vinosaamaa/chanter/issues/107). Continue the current issue/PR state in [`launch-execution-status.md`](docs/operations/launch-execution-status.md), preserving existing worktrees. The historical numbered order in [`product-readiness-issue-breakdown.md`](docs/issues/product-readiness-issue-breakdown.md) defines dependencies; an open provider-acceptance issue does not mean its merged implementation must be rebuilt.
...
Epic [#107](https://github.com/Vinosaamaa/chanter/issues/107), with #238 through #241 complete and #242 next. Audit: [`docs/operations/product-readiness-audit-2026-08-09.md`](docs/operations/product-readiness-audit-2026-08-09.md). Order: [`docs/issues/product-readiness-issue-breakdown.md`](docs/issues/product-readiness-issue-breakdown.md). Short agent start: [`docs/operations/new-chat-handoff.md`](docs/operations/new-chat-handoff.md).
...
Start transactional email and durable secure browser sessions [#242](https://github.com/Vinosaamaa/chanter/issues/242), then continue #243–#255 in [`docs/issues/product-readiness-issue-breakdown.md`](docs/issues/product-readiness-issue-breakdown.md) dependency order. Do not claim a public beta until #255 verifies the real deployment.
...
Active: Product Readiness epic #107. Issues #238 through #241 are complete. Implement #242 next, then continue through #255 per docs/issues/product-readiness-issue-breakdown.md. Never push main.

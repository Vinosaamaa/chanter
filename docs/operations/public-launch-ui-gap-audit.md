...
**Owner sign-off required** on P0 vs P1 below before agents start #88–#93 polish slices.
...
- [ ] **P0 list approved** as written, or edited inline (add comment on PR #___ / issue #87).
- [ ] **P1 order** among #88–#93 confirmed (default: #88 → #89 → #90 → #91 → #92 → #93).
- [ ] **Deferrals accepted:** landing/sign-in polish → #102/#104; folder hierarchy on resources; full SaaS billing page.

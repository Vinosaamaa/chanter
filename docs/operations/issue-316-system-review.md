...
| Transport | One MiB frame bound, request timeout, immediate EOF rejection, fixed safe error codes, no diagnostic logging | Production turn cancellation, response/input bounds, one-attempt lifecycle, bounded shutdown evidence |

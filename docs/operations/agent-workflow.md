...
| **UI v2 operationalization** | [Public Launch](https://github.com/Vinosaamaa/chanter/milestone/5) | [#5](https://github.com/users/Vinosaamaa/projects/5) | **Active — #136** under epic #131 |
...
| 7 | [**#136**](https://github.com/Vinosaamaa/chanter/issues/136) | **← ACTIVE** Real Cohort roster, Enrollment, and TA assignment — complete locally |
| 8 | [#137](https://github.com/Vinosaamaa/chanter/issues/137) | **NEXT** Course Chat channel management and voice entry |
...
| 4 | [#131](https://github.com/Vinosaamaa/chanter/issues/131) | Make UI v2 fully operational — **active at #136** |
...
Active work: Public Launch project #5 — epic **#131**, active slice **#136** (`feature/136-real-cohort-roster-enrollment-ta`). #136 is locally complete; finish PR/CI/CodeAnt/merge, then start **#137**.

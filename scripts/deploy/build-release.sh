...
cp scripts/deploy/{host.mjs,release.mjs,recovery.mjs,backup-runner.mjs,telemetry.mjs,errors.mjs,heartbeat.mjs,configuration-backup.mjs,restore-isolated.mjs} "$output/scripts/deploy/"

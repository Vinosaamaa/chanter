...
cp scripts/deploy/{host.mjs,release.mjs,recovery.mjs,recovery-runtime.mjs,backup-runner.mjs,telemetry.mjs,errors.mjs,heartbeat.mjs,configuration-backup.mjs,resource-object-backup.mjs,restore-isolated.mjs,restore-current-authority.mjs} "$output/scripts/deploy/"
